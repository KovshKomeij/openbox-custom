...
echo "Openbox custom by dibil228of, created by Andronix"
pkg install wget -y 
folder=debian-fs
...
if [ ! -f /root/openbox.sh ]; then
    wget --tries=20 https://raw.githubusercontent.com/dibil228of/openbox-custom/main/termux/openbox.sh -O /root/openbox.sh
    bash ~/openbox.sh
else
    bash ~/openbox.sh
fi
